...
namespace Plato.Configuration
{
    ...
    public static class ConfigManager
    {
        ...
        {
            var value = string.Format("{0}.{1}.{2}", fileName, sectionName, settingsSectionName).ToLower();
            return (int)value.BKDRHash();
        }
        ...
        {
            return GetConfiguration(ConfigHelper.GetRootConfigFile());
        }
        ...
        {            
            return GetConfiguration(ConfigHelper.GetRootConfigFile(), sectionName, settingsSectionName);
        }
