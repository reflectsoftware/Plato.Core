...
namespace Plato.Security.Extensions
{
    ...
    public static class RSAKeyExtensions
    {
        #region XML
        /// <summary>
        /// From the XML string format.
        /// </summary>
        /// <param name="rsa">The RSA.</param>
        /// <param name="xmlString">The XML string.</param>
        /// <exception cref="Exception">Invalid XML RSA key.</exception>
        public static void FromXmlStringFormat(this RSA rsa, string xmlString)
        {
        ...
        /// <summary>
        /// To the XML string format.
        /// </summary>
        /// <param name="rsa">The RSA.</param>
        /// <param name="includePrivateParameters">if set to <c>true</c> [include private parameters].</param>
        /// <returns></returns>
        public static string ToXmlStringFormat(this RSA rsa, bool includePrivateParameters)
        {
