...
using Nito.AsyncEx;
using Plato.Locks.Interfaces;
using System;
using System.Collections.Generic;
using System.Threading;

namespace Plato.Locks
{
    /// <summary>
    /// https://github.com/StephenCleary/AsyncEx/wiki/AsyncReaderWriterLock
    /// </summary>
    /// <seealso cref="Plato.Locks.Interfaces.IResourceLockAsync"/>
    public class ResourceLockAsync : IResourceLockAsync
    {
        private class ResourceLockInfo : IDisposable
        {
            ...
            /// The lock.
            /// </value>
            public AsyncReaderWriterLock Lock { get; internal set; }
